...
class GymBase(m64pai.Emulator):
    def __init__(self):
        config_path = join(getcwd(), "venv/lib/python3.7/site-packages/m64pai/share/m64pai/data/")
        super(GymBase, self).__init__(config_path, config_path, audio_plugin=None, video_plugin=None)
        ...
        self.game = self.load_ssb64_rom("roms/Super Smash Bros. (U) [!].z64")
        self.load_state(join(config_path, "savestates/pika-vs-pika_dreamland_ai.m64savestate"))
