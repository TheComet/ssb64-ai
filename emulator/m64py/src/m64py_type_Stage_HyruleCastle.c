...
PyTypeObject m64py_HyruleCastleType = {
    ...
    "m64py.HyruleCastle",         /* tp_name */
    sizeof(m64py_HyruleCastle),   /* tp_basicsize */
    0,                            /* tp_itemsize */
    (destructor)HyruleCastle_dealloc, /* tp_dealloc */
    0,                            /* tp_print */
    0,                            /* tp_getattr */
    0,                            /* tp_setattr */
    0,                            /* tp_reserved */
