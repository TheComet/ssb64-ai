...
PyTypeObject m64py_CaptainFalconType = {
    ...
    "m64py.CaptainFalcon",        /* tp_name */
    sizeof(m64py_CaptainFalcon),  /* tp_basicsize */
    0,                            /* tp_itemsize */
    (destructor)CaptainFalcon_dealloc,  /* tp_dealloc */
    0,                            /* tp_print */
    0,                            /* tp_getattr */
    0,                            /* tp_setattr */
    0,                            /* tp_reserved */
