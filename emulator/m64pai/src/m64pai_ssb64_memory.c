...
m64pai_memory_interface_create(m64pai_Emulator_corelib_interface* corelib, m64pai_region_e region)
{
    m64pai_memory_interface_t* memory = malloc(sizeof *memory);
    if (memory == NULL)
        return NULL;
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_interface_destroy(m64pai_memory_interface_t* memory)
{
    free(memory);
}
...
/* -------------------------------------------------------------------------- */
int
m64pai_memory_is_match_in_progress(m64pai_memory_interface_t* memory)
{
...
/* -------------------------------------------------------------------------- */
static uint32_t
get_match_settings(m64pai_memory_interface_t* memory, const char** error_msg)
{
...
/* -------------------------------------------------------------------------- */
int
m64pai_memory_match_settings_get_time(m64pai_memory_interface_t* memory, uint8_t* time_in_minutes, const char** error_msg)
{
...
/* -------------------------------------------------------------------------- */
int
m64pai_memory_match_settings_get_stocks(m64pai_memory_interface_t* memory, uint8_t* stockcount, const char** error_msg)
{
    uint32_t match_settings;
    if (!(match_settings = get_match_settings(memory, error_msg)))
        return 0;
...
/* -------------------------------------------------------------------------- */
int
m64pai_memory_match_settings_get_stocks_timed(m64pai_memory_interface_t* memory, int* stockcount, int* time_in_minutes, const char** error_msg)
{
    uint32_t match_settings;
    if (!(match_settings = get_match_settings(memory, error_msg)))
        return 0;
...
/* -------------------------------------------------------------------------- */
int
m64pai_memory_match_settings_get_fighter_character(m64pai_memory_interface_t* memory, int player_slot, m64pai_character_e* character, const char** error_msg)
{
    uint32_t match_settings;
    if (!(match_settings = get_match_settings(memory, error_msg)))
        return 0;
...
/* -------------------------------------------------------------------------- */
int
m64pai_memory_match_settings_get_stage(m64pai_memory_interface_t* memory, m64pai_stage_e* stage, const char** error_msg)
{
    uint32_t match_settings;
    if (!(match_settings = get_match_settings(memory, error_msg)))
        return 0;
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_whispy_wind(m64pai_memory_interface_t* memory, float* blowing_direction)
{
    uint32_t blow_raw;
...
/* -------------------------------------------------------------------------- */
int
m64pai_memory_get_fighter_address(m64pai_memory_interface_t* memory, int fighter_idx, uint32_t* fighter_address, const char** error_msg)
{
    /*
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_character(m64pai_memory_interface_t* memory, uint32_t fighter_address, m64pai_character_e* fighter)
{
...
/* -------------------------------------------------------------------------- */
int
m64pai_memory_read_fighter_position(m64pai_memory_interface_t* memory, uint32_t fighter_address, float* xpos, float* ypos, const char** error_msg)
{
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_velocity(m64pai_memory_interface_t* memory, uint32_t fighter_address, float* xvel, float* yvel)
{
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_acceleration(m64pai_memory_interface_t* memory, uint32_t fighter_address, float* xacc, float* yacc)
{
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_orientation(m64pai_memory_interface_t* memory, uint32_t fighter_address, int32_t* orientation)
{
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_movement_frame(m64pai_memory_interface_t* memory, uint32_t fighter_address, uint32_t* frame)
{
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_movement_state(m64pai_memory_interface_t* memory, uint32_t fighter_address, int16_t* state)
{
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_shield_health(m64pai_memory_interface_t* memory, uint32_t fighter_address, uint32_t* shield)
{
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_shield_break_recovery_timer(m64pai_memory_interface_t* memory, uint32_t fighter_address, uint32_t* time_left)
{
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_percent(m64pai_memory_interface_t* memory, uint32_t fighter_address, uint32_t* percent)
{
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_is_invincible(m64pai_memory_interface_t* memory, uint32_t fighter_address, int* is_invincible)
{
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_is_grounded(m64pai_memory_interface_t* memory, uint32_t fighter_address, int* is_grounded)
{
...
/* -------------------------------------------------------------------------- */
void
m64pai_memory_read_fighter_stocks(m64pai_memory_interface_t* memory, int fighter_idx, uint8_t* stock_count)
{
